"""Portal de administração dos registros financeiros.

É por aqui que se alcança o que as telas não expõem: editar um parcelamento,
mexer num investimento, desfazer uma transação derivada pela origem dela. As
telas cuidam do dia a dia; este módulo cuida do que exige saber o que se faz.
"""
