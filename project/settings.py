...
MIDDLEWARE = [
    ...
    # Depois do OTPMiddleware, que é quem diz se a sessão passou pelo código.
    'project.middleware.RequireOTPMiddleware',
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'FinFlow <noreply@localhost>')
